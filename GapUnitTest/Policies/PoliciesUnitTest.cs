...
namespace GapUnitTest.Policies
{
    ...
    public class PoliciesUnitTest
    {
        ...
        public void CreatePolicy()
        {
            ...
            coverages.Add(new PoliciesCoverages() { Id = 1, CoverageTypeId = 1, Percentage = 7 });
            coverages.Add(new PoliciesCoverages() { Id = 2, CoverageTypeId = 2, Percentage = 7 });
            coverages.Add(new PoliciesCoverages() { Id = 3, CoverageTypeId = 3, Percentage = 7 });
            coverages.Add(new PoliciesCoverages() { Id = 4, CoverageTypeId = 4, Percentage = 7 });
        ...
        public void CreatePolicyHighRisk()
        {
            ///Arange
            var mockPolicy = new Mock<IPolicyDao>();
